    ...
    <section id="pricing" className="py-24 relative bg-[#090909] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Unbeatable <span className="bg-gradient-to-r from-white via-cyan-100 to-[#00f0ff] bg-clip-text text-transparent">Console Gaming Rates</span>
          </motion.h2>
          ...
          >
            Simple hourly pricing with no hidden charges. Choose your squad size and level up today.
          </motion.p>
        </div>
          ...
          {pricingTiers.map((tier, idx) => (
            <motion.div
              ...
              className={`glass-card rounded-3xl p-6 relative flex flex-col justify-between border ${
                tier.popular
                  ? 'border-[#00f0ff] shadow-2xl shadow-[#00f0ff]/10 bg-gradient-to-b from-white/[0.08] to-white/[0.02]'
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mb-6 pb-6 border-b border-white/10">
                  ...
                  {/* Book Now Button on the right side of the price */}
                  <button
                    onClick={() => {
                      audioService.playClickSound();
                      onSelectTier(tier.playerCount);
                    }}
                    className="btn-gradient px-4 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-lg group shrink-0"
                  >
              ...
              <button
                ...
                className="w-full py-3 rounded-2xl bg-white/5 border border-white/10 hover:bg-[#00f0ff]/20 hover:border-[#00f0ff] text-white text-xs font-bold tracking-wider uppercase transition-all flex items-center justify-center gap-2"
              >
                <span>Select {tier.players}</span>
              </button>
            </motion.div>
          ))}
        </div>
